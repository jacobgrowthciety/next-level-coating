...
const PREV_SECTION_BG = '#141414' // FlakeColorChartGallery's section background
...
/** Lead capture CTA for the Flake Color Chart page (reference/BRIEF.md §6, §8). */
export default function FlakeColorChartCTA() {
  return (
    <section id="quote" className="relative z-40 scroll-mt-20" style={{ backgroundColor: SECTION_BG }}>
      {/* Gallery → CTA (dark → teal): teal torn shape over the dark section above
      ...
      <div className="px-6 pb-24 pt-4">
        ...
        >
          <div className="max-w-xl text-center lg:text-left">
            ...
            >
              Let's turn it into a floor — one-day installs, a lifetime warranty, and a crew
              that treats every chip color like it's the only one that matters.
            </motion.p>
