...
const PREV_SECTION_BG = '#f4f3ef' // PoolDecksDetails' light body
...
/** Lead capture CTA for the Pool Decks page (reference/BRIEF.md §6, §8). */
export default function PoolDecksCTA() {
  return (
