...
const PREV_SECTION_BG = '#f4f3ef' // ResidentialDetails' light body
...
/** Lead capture CTA for the Residential page (reference/BRIEF.md §6, §8). */
        ...
        >
          <div className="max-w-xl text-center lg:text-left">
            ...
            <motion.h2 variants={fadeUp} className="mt-3 font-script text-4xl text-brand-black sm:text-5xl lg:text-6xl">
              Ready For Your Next Level Home?
            </motion.h2>
            <motion.p variants={fadeUp} className="mx-auto mt-6 max-w-md text-lg leading-relaxed text-brand-black/80 lg:mx-0">
              A lifetime warranty and a six-step process built for same-day completion. Let's get
              your quote started.
            </motion.p>
