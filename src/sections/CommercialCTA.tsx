...
/** Lead capture CTA for the Commercial page (reference/BRIEF.md §6, §8). */
        ...
        >
          <div className="max-w-xl text-center lg:text-left">
            ...
            <motion.p variants={fadeUp} className="mx-auto mt-6 max-w-md text-lg leading-relaxed text-brand-black/80 lg:mx-0">
              Certified installers, premium products, and a finish that holds up to daily
              business. Let's get your quote started.
            </motion.p>
