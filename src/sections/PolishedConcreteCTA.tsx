...
const PREV_SECTION_BG = '#f4f3ef' // PolishedConcreteDetails' light body
...
/** Lead capture CTA for the Polished Concrete page (reference/BRIEF.md §6, §8). */
export default function PolishedConcreteCTA() {
  return (
        ...
        >
          <div className="max-w-xl text-center lg:text-left">
            ...
            <motion.h2 variants={fadeUp} className="mt-3 font-script text-4xl text-brand-black sm:text-5xl lg:text-6xl">
              Ready For Your Next Level Shine?
            </motion.h2>
            <motion.p variants={fadeUp} className="mx-auto mt-6 max-w-md text-lg leading-relaxed text-brand-black/80 lg:mx-0">
              A sleek, low-maintenance finish straight from your existing slab. Let's get your
              quote started.
            </motion.p>
