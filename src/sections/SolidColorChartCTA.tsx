...
const PREV_SECTION_BG = '#141414' // SolidColorChartGrid's section background
...
/** Lead capture CTA for the Solid Color Chart page (reference/BRIEF.md §6, §8). */
export default function SolidColorChartCTA() {
  return (
    <section id="quote" className="relative z-40 scroll-mt-20" style={{ backgroundColor: SECTION_BG }}>
      {/* Grid → CTA (dark → teal): teal torn shape over the dark section above (revealColor),
          a self-contained boundary between two in-flow sections. */}
      ...
      <div className="px-6 pb-24 pt-4">
        ...
        >
          <div className="max-w-xl text-center lg:text-left">
            ...
            >
              Tell us the color you're leaning toward and we'll walk you through how it looks
              on a real floor — one-day installs, a lifetime warranty, no pressure.
            </motion.p>
