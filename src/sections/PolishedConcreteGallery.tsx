...
const PREV_SECTION_BG = '#000000' // PolishedConcreteIntro's section background

// 6 real project photos (public/services/polished-concrete/), pulled from the old site's
// /copy-of-grind-seal gallery (that page had no body copy, only photos). 2 featured + 4 small =
// 12 grid cells, tiling cleanly across 3 rows of 4 on desktop. No reviews callout below this
// gallery — see PolishedConcrete.tsx for why.
const PHOTOS: { id: string; src: string; caption: string; alt: string; size: 'featured' | 'small' }[] = [
  {
    id: 'pc1',
    src: '/services/polished-concrete/polished-concrete-01.webp',
    caption: 'Polished Concrete Finish',
    alt: 'Diamond-polished concrete floor with a high-shine finish, Next Level Coatings project',
    size: 'featured',
  },
  {
    id: 'pc2',
    src: '/services/polished-concrete/polished-concrete-02.webp',
    caption: 'Diamond Grinding Process',
    alt: 'Diamond grinding equipment preparing a concrete floor for polishing',
    size: 'featured',
  },
  {
    id: 'pc3',
    src: '/services/polished-concrete/polished-concrete-03.webp',
    caption: 'High-Shine Concrete Floor',
    alt: 'Close-up of a high-shine polished concrete surface',
    size: 'small',
  },
  {
    id: 'pc4',
    src: '/services/polished-concrete/polished-concrete-04.webp',
    caption: 'Polished Concrete Finish',
    alt: 'Wide view of a polished concrete floor installation',
    size: 'small',
  },
  {
    id: 'pc5',
    src: '/services/polished-concrete/polished-concrete-05.webp',
    caption: 'Smooth Concrete Surface',
    alt: 'Smooth, low-maintenance polished concrete surface',
    size: 'small',
  },
  {
    id: 'pc6',
    src: '/services/polished-concrete/polished-concrete-06.webp',
    caption: 'Diamond Grinding Process',
    alt: 'Freshly polished concrete floor ready for use',
    size: 'small',
  },
]
...
/** Photo gallery for the Polished Concrete page (reference/BRIEF.md §9A pattern, no reviews). */
export default function PolishedConcreteGallery() {
