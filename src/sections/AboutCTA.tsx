...
const PREV_SECTION_BG = '#f4f3ef' // AboutStory's light body
...
/** Lead capture CTA for the About page (reference/BRIEF.md §6, §8). */
export default function AboutCTA() {
  return (
    <section id="quote" className="relative z-40 scroll-mt-20" style={{ backgroundColor: SECTION_BG }}>
      {/* Story → CTA (light → teal): teal torn shape over the off-white section above
      ...
      <div className="px-6 pb-24 pt-4">
        ...
        >
          <div className="max-w-xl text-center lg:text-left">
            ...
            >
              We'd love to bring the same care we give our own family's projects to yours —
