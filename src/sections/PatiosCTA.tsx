...
const PREV_SECTION_BG = '#f4f3ef' // PatiosDetails' light body
...
/** Lead capture CTA for the Patios page (reference/BRIEF.md §6, §8). */
export default function PatiosCTA() {
  return (
        ...
        >
          <div className="max-w-xl text-center lg:text-left">
            ...
            <motion.h2 variants={fadeUp} className="mt-3 font-script text-4xl text-brand-black sm:text-5xl lg:text-6xl">
              Ready For Your Next Level Outdoors?
            </motion.h2>
            <motion.p variants={fadeUp} className="mx-auto mt-6 max-w-md text-lg leading-relaxed text-brand-black/80 lg:mx-0">
              UV-stable, cooler underfoot, and built to last a lifetime. Let's get your patio,
              sidewalk, or driveway quote started.
            </motion.p>
